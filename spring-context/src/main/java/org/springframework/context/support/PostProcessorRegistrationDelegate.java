...
final class PostProcessorRegistrationDelegate {
	...
	public static void invokeBeanFactoryPostProcessors(
		...
		if (beanFactory instanceof BeanDefinitionRegistry) {
			...
			// 硬编码(即自己编写的类，实现了beanFactoryPostProcessors接口,并手动添加到beanFactoryPostProcessors容器中)注册的后处理器
			...
			//执行BeanDefinitionRegistryPostProcessor接口的方法：postProcessBeanDefinitionRegistry
		...
		// 注意：其实并没注册到beanFactoryPostProcessors这个容器中，只是和普通的单例Bean都放在了一级缓存中
		String[] postProcessorNames =
		...
		for (String postProcessorName : nonOrderedPostProcessorNames) {
			//如果容器中该Bean还没有实例化，则实例化(即BeanFactoryPostProcessor先实例化，然后执行)
	...
	public static void registerBeanPostProcessors(
		...
		// 这一步会获取到我们的CarBeanPostProcessor的beanName
	...
	private static void invokeBeanFactoryPostProcessors(
		...
		//这里回调我们在carBeanFactoryPostProcessor中重写的postProcessBeanFactory方法
